  ...
  return (
    <>
      ...
      <nav style={{
        ...
        <div className="nav-inner" style={{ maxWidth: "780px", margin: "0 auto", padding: "0 24px", height: "52px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>

          {/* 1줄: 이름 + 언어토글 */}
          <div className="nav-top-row" style={{ display: "contents" }}>
          ...
          {/* 2줄 (모바일 전용): 링크들 */}
          <div className="nav-links-row" style={{ display: "none" }}>
            {navLinks.map((l) => (
              <a key={l.href} href={l.href} style={{
                color: "var(--muted)", fontSize: "13px", fontWeight: 400,
