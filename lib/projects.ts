...
export const projects: Project[] = [
  ...
  },
  {
    ...
    categoryKo: "외부 API 연동",
    title: "TMAP Transit Congestion Heatmap",
    titleKo: "TMAP 대중교통 혼잡도 히트맵",
    desc: "Data analysis project integrating SK TMAP's public transit API to visualize station congestion and identify major transfer hubs. Extracts congestion time-series data, calculates top-10 high-traffic routes/pairs, and renders geospatial heatmaps.",
    descKo: "SK TMAP 대중교통 API를 연동해 역별 혼잡도 시각화 및 주요 환승 허브를 파악하는 데이터 분석 프로젝트. 혼잡도 시계열 데이터 추출, 상위 10개 고트래픽 구간/쌍 산출, 지리공간 히트맵 렌더링.",
    tags: ["Python", "TMAP API", "Geospatial", "heatmap", "시계열 분석"],
    highlights: [
      "SK Open API (TMAP) integration",
      "Station congestion time-series extraction",
      "Top-10 high-traffic hub identification",
      "Geospatial heatmap visualization",
      "PDF API guide parsing & automation",
    ],
    highlightsKo: [
      "SK Open API (TMAP) 연동",
      "역별 혼잡도 시계열 데이터 추출",
