...
export const projects: Project[] = [
  {
    ...
    title: "AA Export Workflow",
    titleKo: "AA 데이터 추출 워크플로우",
    desc: "Designed and built the full orchestration layer on top of the AA extraction engine — covering automated notebook generation, 3-way validation, FAILED status reporting, and the entire post-processing pipeline. Reduced end-to-end reporting turnaround from several days to ~2 hours.",
    descKo: "AA 추출 엔진 위에 전체 오케스트레이션 레이어를 설계·구축. JSON 설정 기반 노트북 자동 생성, 3방향 검수 시스템, FAILED 건 리포팅, 후처리 파이프라인 전체를 포함. 전체 리포팅 소요 시간을 수일에서 약 2시간으로 단축.",
    tags: ["Python", "Adobe Analytics API (requests)", "Jupyter", "pandas", "자동화"],
    highlights: [
      "6 notebooks auto-generated from JSON config",
      "3-way validation: JSON ↔ column mapping ↔ notebook references",
      "FAILED status report + US zero-row warning",
      "Post-processing: wide→long, currency adj., channel classification, dummy row insertion",
      "Multi-year / multi-region (NY, US, Prior) support",
    ],
    highlightsKo: [
      "JSON 설정에서 6개 노트북 자동 생성",
      "JSON ↔ 컬럼 매핑 ↔ 노트북 참조 3방향 검수",
      "FAILED 건 리포트 + US OK 행 0개 별도 경고",
      "후처리: wide→long 변환, 환율 적용, 채널 분류, dummy 행 삽입",
...
export const skillCategories = [
  ...
  },
  {
    name: "Analytics & APIs",
    nameKo: "애널리틱스 & API",
    items: ["Adobe Analytics", "Adobe Analytics API (requests)", "GA4"],
  },
  {
  ...
  },
  {
    ...
    nameKo: "시각화 & 리포팅",
    items: ["Sankey Diagram", "Heatmap", "Excel Automation", "HTML Report", "Plotly", "Figma (UI Prototyping)"],
  },
];
